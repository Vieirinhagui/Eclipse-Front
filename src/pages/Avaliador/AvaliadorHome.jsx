  ...
  return (
    <CardContainer>
        <ConteudoCard>
            ...
            <div>
                <p><strong>Peças Avaliadas</strong></p>
                <p>Total: <strong>20 peças</strong></p>
            </div>
            <ButtonDetalhes>
                Detalhes
            </ButtonDetalhes>
        ...
        <ConteudoCard>
            ...
            <div>
                <p><strong>Área mais avaliada</strong></p>
                <p><strong>Área:</strong> Cívil</p>
            </div>
            <ButtonDetalhes>
                Detalhes
            </ButtonDetalhes>
